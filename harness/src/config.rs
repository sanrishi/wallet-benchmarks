...
"#
    ...
    fn loads_full_config() {
        ...
        assert_eq!(c.benchmark.confirmation_timeout_secs, 600);
    ...
    fn accepts_zero_values_for_all_numeric_fields() {
        let toml = sample_toml()
            ...
            .replace("confirmation_timeout_secs = 600", "confirmation_timeout_secs = 0")
        ...
        assert_eq!(c.benchmark.confirmation_timeout_secs, 0);
    ...
    prop_compose! {
        fn arbitrary_config()(
            ...
            confirmation_timeout_secs in 0u64..3600u64,
    ...
    proptest! {
        ...
        fn config_toml_round_trip(cfg in arbitrary_config()) {
            ...
            assert_eq!(deserialized.benchmark.confirmation_timeout_secs, cfg.benchmark.confirmation_timeout_secs);
